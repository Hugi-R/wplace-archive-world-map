...
use crate::image::{PalettedImage, compressed_bytes_to_paletted, paletted_to_compressed_bytes, downscale_mode_weighted_2x2, merge_2x2};
use crate::merge;
...
pub fn merge(input: &str, base: &str, workers: usize) -> Result<(), Box<dyn Error>> {
    if workers > 0 {
